...
nssm set voila_servers AppStdout C:\Users\Public\Documents\physics-server\RCCC\voila\voila_log.txt
nssm set voila_servers AppStderr C:\Users\Public\Documents\physics-server\RCCC\voila\voila_log.txt
